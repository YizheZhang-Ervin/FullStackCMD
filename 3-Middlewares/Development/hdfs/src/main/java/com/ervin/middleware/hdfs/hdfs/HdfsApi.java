...
public class HdfsApi {
	 ...
	 * @throws IOException
	 * @throws InterruptedException
	 * @throws com.ervin.middleware.hdfs.exception.HdfsApiException
	 */
	public HdfsApi(Configuration configuration, FileSystem fs, UserGroupInformation ugi)
			throws IOException, InterruptedException, com.ervin.middleware.hdfs.exception.HdfsApiException {
	...
	public boolean rename(final String srcPath, final String dstPath) throws Exception {
		return execute(new PrivilegedExceptionAction<Boolean>() {
			public Boolean run() throws com.ervin.middleware.hdfs.exception.HdfsApiException {
				boolean flag = false;
				try {
	 ...
	 * @throws InterruptedException
	 */
	public void putStringToFile(final String filePath, final String content) throws com.ervin.middleware.hdfs.exception.HdfsApiException {
		try {
			execute(new PrivilegedExceptionAction<Void>() {
				public Void run() throws IOException, InterruptedException {
			...
			throw new com.ervin.middleware.hdfs.exception.HdfsApiException("HDFS020 Could not write file " + filePath, e);
		} catch (InterruptedException e) {
			throw new com.ervin.middleware.hdfs.exception.HdfsApiException("HDFS021 Could not write file " + filePath, e);
		}
	}
	 ...
	 * @throws com.ervin.middleware.hdfs.exception.HdfsApiException
	 */
	public void appendStringToFile(final String filePath, final String content) throws com.ervin.middleware.hdfs.exception.HdfsApiException {
		try {
			execute(new PrivilegedExceptionAction<Void>() {
				public Void run() throws IOException, InterruptedException {
					// 创建一个文件，并拿到文件的FS数据输出流，便于写入字节
			...
			throw new com.ervin.middleware.hdfs.exception.HdfsApiException("HDFS020 Could not append file " + filePath, e);
		} catch (InterruptedException e) {
			throw new com.ervin.middleware.hdfs.exception.HdfsApiException("HDFS021 Could not append file " + filePath, e);
		}
	}
	 ...
	 * @throws InterruptedException
	 */
	public String readFileToString(final String filePath) throws com.ervin.middleware.hdfs.exception.HdfsApiException {
		...
		try {
			...
			throw new com.ervin.middleware.hdfs.exception.HdfsApiException("HDFS060 Could not read file " + filePath, e);
		} catch (InterruptedException e) {
